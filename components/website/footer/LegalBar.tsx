...
export function LegalBar() {
  ...
  return (
    <div className="border-t border-[#1A1A1A]/10">
      <div className="max-w-[1440px] mx-auto px-4 sm:px-6 md:px-10 py-4 flex flex-col sm:flex-row items-center justify-between gap-2 text-[10px] sm:text-xs text-[#1A1A1A]/60">
        <p>
